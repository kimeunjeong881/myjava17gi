...
<body>
	<div id="wrap" align="center">
		<h1>상품 수정 - 관리자 페이지</h1>
		<!-- action이 없으면 default로 자기자신을 호출 -->
		<!-- 서블릿에서 forward로 넘어왔으므로 현재파일에서 default로 서블릿주소를 호출 -->
		<form method="post" enctype="multipart/form-data" name="frm">
			...
			<!-- script/product.js에서 검증을위한 productCheck()가 true 리턴시 폼 전송 -->
			<!-- onclick을 거친 후 submit -->
