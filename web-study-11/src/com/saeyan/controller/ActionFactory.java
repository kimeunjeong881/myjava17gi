...
import com.saeyan.controller.action.BoardList2Action;
...
public class ActionFactory {
	...
	public Action getAction(String command) {
		...
		if (command.equals("board_list")) { // 요청분석
			action = new BoardListAction(); // AC 객체 생성
			...
			action = new BoardList2Action();
		}
		return action; // AC 객체 리턴
	}
}
